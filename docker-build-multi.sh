...
# tagging
docker tag ${SERVICE_NAME}:"${DATE}" ${SERVICE_NAME}-1:latest
docker tag ${SERVICE_NAME}:"${DATE}" ${REPOSITORY_PREFIX}/${SERVICE_NAME}-1:"${DATE}"
docker tag ${REPOSITORY_PREFIX}/${SERVICE_NAME}-1:"${DATE}" ${REPOSITORY_PREFIX}/${SERVICE_NAME}-1:latest
