...
from .cv2_template_matching import OpencvTemplateMatching
...
class Matcher:
    def __init__(self, templates, image_path, template_timestamp):
        self.cv2_img = initialize_cv2_image()
        self.cv2_temp_match = OpencvTemplateMatching()
